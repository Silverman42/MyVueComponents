<template>
    <div>
        ...
        <div class="flex mb-1 bg-primaryBg-200 border border-primaryBg-400 text-black h-12 overflow-hidden rounded leading-tight focus:bg-primaryBg-300 focus:border-primary-300" tabindex="-1">
            <select
                ref="select"
                v-bind="$attrs"
                v-model="selected"
